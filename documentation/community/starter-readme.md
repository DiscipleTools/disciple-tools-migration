![Build Status](https://github.com/DiscipleTools/disciple-tools-migration/actions/workflows/ci.yml/badge.svg?branch=master)

# Disciple.Tools - Migrations
...
#### Framework
 ...
 1. Disciple.Tools Theme presence check. ```disciple_tools_migration()```
...
[Issues](https://github.com/DiscipleTools/disciple-tools-migration/issues) section of the repo. You can present ideas
in the [Discussions](https://github.com/DiscipleTools/disciple-tools-migration/discussions) section of the repo. And
code contributions are welcome using the [Pull Request](https://github.com/DiscipleTools/disciple-tools-migration/pulls)
system for git. For a more details on contribution see the
[contribution guidelines](https://github.com/DiscipleTools/disciple-tools-migration/blob/master/CONTRIBUTING.md).
