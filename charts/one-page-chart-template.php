...
class Disciple_Tools_Migration_Chart_Template extends DT_Metrics_Chart_Base
{
    public $base_slug = 'disciple-tools-migration-metrics'; // lowercase
    public $base_title = 'Migrations Metrics';
