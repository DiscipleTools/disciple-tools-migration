...
class Disciple_Tools_Migration_Menu {
     ...
     * @since 0.1.0
     * @static
     * @return Disciple_Tools_Migration_Menu instance
     */
    ...
    public function __construct() {
        ...
        $this->page_title = __( 'Migrations', 'disciple-tools-migration' );
    } // End __construct()
    ...
    public function content() {
        ...
        <div class="wrap">
            ...
            switch ( $tab ) {
                case 'general':
                    $object = new Disciple_Tools_Migration_Tab_General();
                    $object->content();
                    break;
                case 'second':
                    $object = new Disciple_Tools_Migration_Tab_Second();
                    $object->content();
                    break;
                default:
                    break;
...
/**
 * Class Disciple_Tools_Migration_Tab_General
 */
class Disciple_Tools_Migration_Tab_General {
    public function content() {
        ?>
    ...
    public function main_column() {
        $token = Disciple_Tools_Migration_Menu::instance()->token;
...
/**
 * Class Disciple_Tools_Migration_Tab_Second
 */
class Disciple_Tools_Migration_Tab_Second {
    public function content() {
        ?>
