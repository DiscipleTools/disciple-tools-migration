...
/**
 * Class Disciple_Tools_Migration_Magic_User_App
 */
class Disciple_Tools_Migration_Magic_Login_User_App extends DT_Magic_Url_Base {

    public $page_title = 'Migration - Magic Links - Login User App';
    public $page_description = 'Login User App - Magic Links.';
    public $root = 'migration_magic_login_app'; // @todo define the root of the url {yoursite}/root/type/key/action
    public $type = 'migration_user_login_app'; // @todo define the type
