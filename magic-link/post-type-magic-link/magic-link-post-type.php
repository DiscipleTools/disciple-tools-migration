...
/**
 * Class Disciple_Tools_Migration_Magic_Link
 */
class Disciple_Tools_Migration_Magic_Link extends DT_Magic_Url_Base {

    public $magic = false;
    public $parts = false;
    public $page_title = 'Migration - Magic Links - Post Type';
    public $page_description = 'Post Type - Magic Links.';
    public $root = 'migration_magic_app'; // @todo define the root of the url {yoursite}/root/type/key/action
    public $type = 'migration_magic_type'; // @todo define the type
    public $post_type = 'migrations'; // @todo set the post type this magic link connects with.
    private $meta_key = '';
