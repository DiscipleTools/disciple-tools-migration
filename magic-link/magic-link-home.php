 ...
 */
class Disciple_Tools_Migration_Magic_Home_App extends DT_Magic_Url_Base
{
    public $magic = false;
    public $parts = false;
    ...
    public $type = 'home';
    public static $token = 'migration_app_home';
...
Disciple_Tools_Migration_Magic_Home_App::instance();
