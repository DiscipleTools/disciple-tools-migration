 ...
 */
class Disciple_Tools_Migration_Magic_User_App extends DT_Magic_Url_Base {

    public $page_title = 'Migration - Magic Links - User App';
    ...
    public $type = 'migration_user_app'; // @todo define the type
