 ...
 */
class Disciple_Tools_Migration_Magic_Map_App extends DT_Magic_Url_Base
{
    public $magic = false;
    public $parts = false;
    public $page_title = 'Migration Map';
    public $root = 'migration_app';
    public $type = 'map';
    public $type_name = 'Migration App Map';
    public static $token = 'migration_app_map';
