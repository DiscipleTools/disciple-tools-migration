...
/**
 * Class Disciple_Tools_Migration_Base
 * Load the core post type hooks into the Disciple.Tools system
 */
class Disciple_Tools_Migration_Base extends DT_Module_Base {
     ...
     * @var string
     */
    public $post_type = 'migrations';
    public $module = 'migration_base';
    public $single_name = 'Migration';
    public $plural_name = 'Migrations';
    ...
    public function after_setup_theme(){
        $this->single_name = __( 'Migration', 'disciple-tools-migration' );
    ...
    public function dt_details_additional_section( $section, $post_type ){
        ...
        if ( $post_type === $this->post_type && $section === 'other' ) {
            ...
            <div class="section-subheader">
                <?php esc_html_e( 'Custom Section Contact', 'disciple-tools-migration' ) ?>
            </div>
            <div>
